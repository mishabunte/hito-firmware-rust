...
//         Err(TransactionParseError::XdrError)
...
//         // // Parse XDR envelope
//         // let mut limited = stellar_xdr::curr::Limited::new(&xdr_bytes, stellar_xdr::curr::Limits::none());
//         // let envelope = TransactionEnvelope::read_xdr_base64(&mut limited)
