...
int crypt0_sig_ber2raw(const uint8_t * ber, uint8_t * raw) 
{
  ...
  if (s_len != 0x20 && s_len != 0x21) {
    //LOG_ERR("wrong s encoded length: %x", s_len); 
